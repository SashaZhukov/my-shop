        ...
        <div class="relative flex top-[20px] justify-center">
            <form method="POST" action="{{ route('user.store') }}">
                ...
                <div class="flex flex-col">
                    ...
                    <input name="login" class="w-[300px] mt-[10px] rounded-[10px]" placeholder="Enter store name">
                </div>
                @error('name')
                ...
                <div class="flex flex-col mt-[15px]">
                    ...
                    <input name="email" class="w-[300px] mt-[10px] rounded-[10px]" placeholder="Enter store phone">
                </div>
                @error('phone')
                <div class="text-red-600 font-semibold leading-6 mt-2 text-[15px]">{{ $message }}</div>
                @enderror
                <div class="flex flex-col mt-[15px]">
                    <label class="text-blueviolet text-[20px] font-medium leading-normal">Working hours</label>
                    <input name="first_name" id="first_name" class="w-[300px] mt-[10px] rounded-[10px]" placeholder="Enter working hours your store">
                </div>
                @error('working_hours')
                <div class="text-red-600 font-semibold leading-6 mt-2 text-[15px]">{{ $message }}</div>
                @enderror
